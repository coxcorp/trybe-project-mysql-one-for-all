...
CREATE TABLE IF NOT EXISTS SpotifyClone.planos (
  plano_id SMALLINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS SpotifyClone.artistas (
	artista_id SMALLINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS SpotifyClone.cancoes (
	cancao_id SMALLINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS SpotifyClone.usuario_seguindo (
	usuario_id SMALLINT NOT NULL,
  seguindo_artista SMALLINT NOT NULL,
  CONSTRAINT PRIMARY KEY(usuario_id, seguindo_artista),
  CONSTRAINT FOREIGN KEY (usuario_id) REFERENCES SpotifyClone.usuarios (usuario_id),
  CONSTRAINT FOREIGN KEY (seguindo_artista) REFERENCES SpotifyClone.artistas (artista_id)
) ENGINE = InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS SpotifyClone.reproducoes (
	usuario_id SMALLINT NOT NULL,
    cancao_id_reproduzida SMALLINT NOT NULL,
    reproducao_data DATETIME NOT NULL,
    CONSTRAINT PRIMARY KEY(usuario_id, cancao_id_reproduzida),
    CONSTRAINT FOREIGN KEY (usuario_id) REFERENCES SpotifyClone.usuarios (usuario_id),
    CONSTRAINT FOREIGN KEY (cancao_id_reproduzida) REFERENCES SpotifyClone.cancoes (cancao_id)
) ENGINE = InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO SpotifyClone.albuns (album_nome, album_ano_lancamento, artista_id)
VALUES
	('Envious', 1990, 1),
	('Exuberant', 1993, 1),
...
INSERT INTO SpotifyClone.usuario_seguindo (usuario_id, seguindo_artista)
VALUES
	(1, 1),
	(1, 4),
	(1, 3),
...
INSERT INTO SpotifyClone.reproducoes (usuario_id, cancao_id_reproduzida, reproducao_data)
VALUES 
